...
const stepIcons = [
  ...
  >
    ...
    <circle
      ...
      cy="40"
      r="28"
      fill="rgba(0,232,122,0.06)"
      stroke="#00E87A"
      strokeWidth="1"
      strokeOpacity="0.5"
    />
    <text x="40" y="47" textAnchor="middle" fontSize="24" fill="#00E87A">
      SiO₂
    </text>
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-shrink-0 flex-col items-center gap-4">
                  <div
                    className="flex h-40 w-40 items-center justify-center rounded-2xl p-6"
                    style={{
                  ...
                  <div
                    className="max-w-[160px] rounded-full px-3 py-1.5 text-center text-xs font-medium"
                    style={{
